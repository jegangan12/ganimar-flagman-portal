...
window.GANIMAR_DATA = {
  ...
  branches: [
    {
      ...
      features: ['Комплексные стратегии', 'Воронки продаж', 'Сквозная аналитика', 'Трафик с учётом до выручки'],
  ...
  subdomains: [
    {
      ...
      cta: 'Открыть визитку',
      desc: 'Mini App: каталог ИИ-продуктов, бронирование слотов, отзывы клиентов и персональный профиль',
    ...
    },
    {
      ...
      tag: '51 проект',
      target: 'Клиентам и партнёрам',
      cta: 'Смотреть 51 проект',
      desc: 'Каталог 51 проекта: у 23 - живое превью реального экрана, 24 открываются по прямой ссылке',
      url: 'https://cases.ganimar.ru'
    },
    {
      id: 'portfolio',
      ...
      desc: 'Презентация направлений, стека и главных кейсов - для сцены и питчей',
    ...
    },
    {
      ...
      cta: 'Читать резюме',
      desc: 'Полный профиль директора по маркетингу / Head of AI, карьерный путь, методология и твёрдые результаты',
  ...
  statsGrid: [
    ...
    },
    {
      ...
      desc: 'Приёмная кампания образовательного холдинга, данные Roistat'
    },
    {
      badge: 'Эффективность',
      number: '×23',
    ...
    },
    {
      ...
      desc: 'Контекст, таргет, медийка, агрегаторы и карты - с учётом до выручки'
    },
    {
      badge: 'Скорость',
      number: '−30%',
      title: 'Сокращение цикла сделки',
      desc: 'За счёт ИИ-ассистентов и мгновенной квалификации лидов'
    },
    {
      badge: 'Опыт',
      number: 'С 2016',
